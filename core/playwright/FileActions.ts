...
export class FileActions {
   ...
   */
  async uploadFiles(locator: Locator, filePaths: string[]): Promise<void> {
   ...
   * );
   */
  async uploadUsingChooser(action: () => Promise<void>, filePath: string): Promise<void> {
   ...
   */
  async downloadFile(action: () => Promise<void>): Promise<Download> {
   ...
   */
  async downloadAndSave(action: () => Promise<void>, savePath: string): Promise<void> {
    const download = await this.downloadFile(action);
