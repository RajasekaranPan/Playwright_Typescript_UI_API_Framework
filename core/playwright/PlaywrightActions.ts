...
export class PlaywrightActions {
    ...
    constructor(
        ...
        this.navigation =
            new NavigationActions(page);

        this.wait =
            new WaitActions(page);

        this.keyboard =
            new KeyboardActions(page);

        this.mouse =
            new MouseActions(page);

        this.frame =
            new FrameActions(page);

        this.file =
            new FileActions(page);

        this.dialog =
            new DialogActions(page);
