...
export class FrameActions {
   ...
   */
  async waitForFrame(predicate: (frame: Frame) => boolean, timeout?: number): Promise<Frame> {
    return await this.page.waitForEvent('frameattached', {
      predicate,
      timeout,
    });
  }
