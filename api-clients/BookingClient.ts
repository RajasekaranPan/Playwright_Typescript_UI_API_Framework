...
export class BookingClient {
  ...
  async createBooking(booking: Booking): Promise<APIResponse> {
    return await this.request.post(ApiRoutes.booking.base, {
      data: booking,
      headers: {
  ...
  async getBooking(bookingId: number): Promise<APIResponse> {
    return await this.request.get(ApiRoutes.booking.byId(bookingId), {
      headers: {
  ...
  async updateBooking(bookingId: number, booking: Booking): Promise<APIResponse> {
    return await this.request.put(ApiRoutes.booking.byId(bookingId), {
      data: booking,
      headers: {
        ...ApiHeaders.commonHeaders,
      },
  ...
  async patchBooking(bookingId: number, booking: Partial<Booking>): Promise<APIResponse> {
    return await this.request.patch(ApiRoutes.booking.byId(bookingId), {
      data: booking,
      headers: {
        ...ApiHeaders.commonHeaders,
      },
  ...
  async deleteBooking(bookingId: number): Promise<APIResponse> {
    return await this.request.delete(ApiRoutes.booking.byId(bookingId), {
      headers: {
        ...ApiHeaders.onlyAcceptJson,
      },
    });
