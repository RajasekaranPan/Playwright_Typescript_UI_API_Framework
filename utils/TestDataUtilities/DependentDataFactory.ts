...
export class DependentDataFactory {
    ...
    public static createSpouse(
        employee: EmployeeData
    ): DependentData {

        const spouseAge =
            this.generateSpouseAge(
                this.calculateAge(
        ...
        const dateOfBirth =
            this.generateDateOfBirthFromAge(
                spouseAge
            );
    ...
    private static generateSpouseAge(
        employeeAge: number
    ): number {
    ...
    private static generateDateOfBirthFromAge(
        age: number
    ): string {
